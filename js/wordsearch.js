...
// 			modified this line from original to creat earlystop when condition = 1
  ...
  WordSeach.prototype.bobmatrix = function(size) {
	...
	var control_matrix = [['K', 'C', 'R', 'A', 'S', 'M', 'C', 'M', 'S', 'C', 'Z', 'E', 'Z', 'E', 'G', 'N', 'X', 'C'],
['P', 'K', 'D', 'T', 'O', 'L', 'O', 'M', 'P', 'A', 'Q', 'U', 'E', 'R', 'T', 'U', 'Y', 'H'],
['R', 'C', 'M', 'O', 'U', 'T', 'V', 'U', 'L', 'R', 'L', 'F', 'R', 'O', 'G', 'T', 'X', 'O'],
['O', 'N', 'A', 'U', 'Q', 'V', 'H', 'S', 'C', 'B', 'F', 'B', 'V', 'F', 'V', 'R', 'Z', 'C'],
['T', 'I', 'A', 'R', 'X', 'K', 'O', 'C', 'V', 'O', 'W', 'Y', 'A', 'A', 'C', 'I', 'S', 'O'],
['E', 'R', 'B', 'N', 'E', 'Z', 'Y', 'L', 'C', 'H', 'A', 'K', 'P', 'N', 'C', 'T', 'O', 'L'],
['I', 'J', 'V', 'A', 'A', 'E', 'C', 'E', 'P', 'Y', 'J', 'Q', 'K', 'A', 'L', 'I', 'U', 'A'],
['N', 'U', 'H', 'M', 'V', 'D', 'R', 'S', 'S', 'D', 'E', 'K', 'O', 'T', 'O', 'O', 'F', 'T'],
['U', 'P', 'P', 'E', 'B', 'Z', 'Y', 'V', 'Y', 'R', 'Q', 'H', 'F', 'O', 'E', 'N', 'H', 'E'],
['U', 'S', 'C', 'N', 'J', 'D', 'R', 'N', 'U', 'A', 'X', 'B', 'A', 'M', 'U', 'H', 'A', 'I'],
['T', 'E', 'D', 'T', 'M', 'M', 'Q', 'B', 'D', 'T', 'L', 'A', 'D', 'Y', 'Z', 'G', 'P', 'B'],
...
['Q', 'S', 'R', 'Z', 'K', 'L', 'O', 'E', 'F', 'K', 'I', 'M', 'I', 'J', 'N', 'T', 'O', 'O'],
['W', 'P', 'A', 'V', 'J', 'E', 'A', 'N', 'Z', 'F', 'M', 'J', 'S', 'O', 'F', 'S', 'A', 'P'],
['H', 'A', 'I', 'G', 'U', 'Z', 'T', 'L', 'X', 'S', 'L', 'R', 'K', 'Z', 'O', 'C', 'M', 'E'],
['R', 'T', 'N', 'D', 'I', 'O', 'A', 'T', 'X', 'B', 'V', 'E', 'Z', 'I', 'I', 'A', 'V', 'E'],
['Y', 'U', 'E', 'X', 'C', 'K', 'E', 'P', 'L', 'G', 'X', 'R', 'I', 'V', 'L', 'L', 'N', 'L'],
['G', 'L', 'R', 'R', 'E', 'O', 'N', 'A', 'T', 'E', 'B', 'A', 'I', 'R', 'F', 'E', 'K', 'E'],
